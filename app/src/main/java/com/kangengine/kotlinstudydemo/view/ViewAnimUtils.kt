...
object ViewAnimUtils {
    ...
    fun animateRevealShow(context : Context, view : View, startRadius : Int,
                          @ColorRes color : Int, listener : OnRevealAnimationListener){
     ...
     * 圆圈凝聚效果
     */
    fun animateRevealHide(context : Context,view : View,finalRadius : Int,@ColorRes color : Int,
